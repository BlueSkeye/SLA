...
namespace Sla.DECCORE
{
    ...
    internal class PrintC : PrintLanguage
    {
        ...
        protected static readonly OpToken hidden = new OpToken { "", "", 1, 70, false, OpToken::hiddenfunction, 0, 0, (OpToken*)0 };
        /// The sub-scope/namespace operator
        protected static readonly OpToken scope = new OpToken { "::", "", 2, 70, true, OpToken::binary, 0, 0, (OpToken*)0 };
        /// The \e member operator
        protected static readonly OpToken object_member = new OpToken { ".", "", 2, 66, true, OpToken::binary, 0, 0, (OpToken*)0 };
        /// The \e points \e to \e member operator
        protected static readonly OpToken pointer_member = new OpToken { ".", "", 2, 66, true, OpToken::binary, 0, 0, (OpToken*)0 };
        /// The array subscript operator
        protected static readonly OpToken subscript = new OpToken { "[", "]", 2, 66, false, OpToken::postsurround, 0, 0, (OpToken*)0 };
        /// The \e function \e call operator
        protected static readonly OpToken function_call = new OpToken { "(", ")", 2, 66, false, OpToken::postsurround, 0, 10, (OpToken*)0 };
        /// The \e bitwise \e negate operator
        protected static readonly OpToken bitwise_not = new OpToken { "~", "", 1, 62, false, OpToken::unary_prefix, 0, 0, (OpToken*)0 };
        /// The \e boolean \e not operator
        protected static readonly OpToken boolean_not = new OpToken { "!", "", 1, 62, false, OpToken::unary_prefix, 0, 0, (OpToken*)0 };
        /// The \e unary \e minus operator
        protected static readonly OpToken unary_minus = new OpToken { "-", "", 1, 62, false, OpToken::unary_prefix, 0, 0, (OpToken*)0 };
        /// The \e unary \e plus operator
        protected static readonly OpToken unary_plus = new OpToken { "+", "", 1, 62, false, OpToken::unary_prefix, 0, 0, (OpToken*)0 };
        /// The \e address \e of operator
        protected static readonly OpToken addressof = new OpToken { "&", "", 1, 62, false, OpToken::unary_prefix, 0, 0, (OpToken*)0 };
        /// The \e pointer \e dereference operator
        protected static readonly OpToken dereference = new OpToken { "*", "", 1, 62, false, OpToken::unary_prefix, 0, 0, (OpToken*)0 };
        /// The \e type \e cast operator
        protected static readonly OpToken typecast = new OpToken { "(", ")", 2, 62, false, OpToken::presurround, 0, 0, (OpToken*)0 };
        /// The \e multiplication operator
        protected static readonly OpToken multiply = new OpToken { "*", "", 2, 54, true, OpToken::binary, 1, 0, (OpToken*)0 };
        /// The \e division operator
        protected static readonly OpToken divide = new OpToken { "/", "", 2, 54, false, OpToken::binary, 1, 0, (OpToken*)0 };
        /// The \e modulo operator
        protected static readonly OpToken modulo = new OpToken { "%", "", 2, 54, false, OpToken::binary, 1, 0, (OpToken*)0 };
        /// The \e binary \e addition operator
        protected static readonly OpToken binary_plus = new OpToken { "+", "", 2, 50, true, OpToken::binary, 1, 0, (OpToken*)0 };
        /// The \e binary \e subtraction operator
        protected static readonly OpToken binary_minus = new OpToken { "-", "", 2, 50, false, OpToken::binary, 1, 0, (OpToken*)0 };
        /// The \e left \e shift operator
        protected static readonly OpToken shift_left = new OpToken { "<<", "", 2, 46, false, OpToken::binary, 1, 0, (OpToken*)0 };
        /// The \e right \e shift operator
        protected static readonly OpToken shift_right = new OpToken { ">>", "", 2, 46, false, OpToken::binary, 1, 0, (OpToken*)0 };
        /// The signed \e right \e shift operator
        protected static readonly OpToken shift_sright = new OpToken { ">>", "", 2, 46, false, OpToken::binary, 1, 0, (OpToken*)0 };
        /// The \e less \e than operator
        protected static readonly OpToken less_than = new OpToken { "<", "", 2, 42, false, OpToken::binary, 1, 0, (OpToken*)0 };
        /// The \e less \e than \e or \e equal operator
        protected static readonly OpToken less_equal = new OpToken { "<=", "", 2, 42, false, OpToken::binary, 1, 0, (OpToken*)0 };
        /// The \e greater \e than operator
        protected static readonly OpToken greater_than = new OpToken { ">", "", 2, 42, false, OpToken::binary, 1, 0, (OpToken*)0 };
        /// The \e greater \e than \e or \e equal operator
        protected static readonly OpToken greater_equal = new OpToken { ">=", "", 2, 42, false, OpToken::binary, 1, 0, (OpToken*)0 };
        /// The \e equal operator
        protected static readonly OpToken equal = new OpToken { "==", "", 2, 38, false, OpToken::binary, 1, 0, (OpToken*)0 };
        /// The \e not \e equal operator
        protected static readonly OpToken not_equal = new OpToken { "!=", "", 2, 38, false, OpToken::binary, 1, 0, (OpToken*)0 };
        /// The \e logical \e and operator
        protected static readonly OpToken bitwise_and = new OpToken { "&", "", 2, 34, true, OpToken::binary, 1, 0, (OpToken*)0 };
        /// The \e logical \e xor operator
        protected static readonly OpToken bitwise_xor = new OpToken { "^", "", 2, 30, true, OpToken::binary, 1, 0, (OpToken*)0 };
        /// The \e logical \e or operator
        protected static readonly OpToken bitwise_or = new OpToken { "|", "", 2, 26, true, OpToken::binary, 1, 0, (OpToken*)0 };
        ///The \e boolean \e and operator
        protected static readonly OpToken boolean_and = new OpToken { "&&", "", 2, 22, false, OpToken::binary, 1, 0, (OpToken*)0 };
        /// The \e boolean \e xor operator
        protected static readonly OpToken boolean_xor = new OpToken { "^^", "", 2, 20, false, OpToken::binary, 1, 0, (OpToken*)0 };
        /// The \e boolean \e or operator
        protected static readonly OpToken boolean_or = new OpToken { "||", "", 2, 18, false, OpToken::binary, 1, 0, (OpToken*)0 };
        /// The \e assignment operator
        protected static readonly OpToken assignment = new OpToken { "=", "", 2, 14, false, OpToken::binary, 1, 5, (OpToken*)0 };
        /// The \e comma operator (for parameter lists)
        protected static readonly OpToken comma = new OpToken { ",", "", 2, 2, true, OpToken::binary, 0, 0, (OpToken*)0 };
        /// The \e new operator
        protected static readonly OpToken new_op = new OpToken { "", "", 2, 62, false, OpToken::space, 1, 0, (OpToken*)0 };

        // Inplace assignment operators
        /// The \e in-place \e multiplication operator
        protected static readonly OpToken multequal = new OpToken { "*=", "", 2, 14, false, OpToken::binary, 1, 5, (OpToken*)0 };
        /// The \e in-place \e division operator
        protected static readonly OpToken divequal = new OpToken { "/=", "", 2, 14, false, OpToken::binary, 1, 5, (OpToken*)0 };
        /// The \e in-place \e modulo operator
        protected static readonly OpToken remequal = new OpToken { "%=", "", 2, 14, false, OpToken::binary, 1, 5, (OpToken*)0 };
        /// The \e in-place \e addition operator
        protected static readonly OpToken plusequal = new OpToken { "+=", "", 2, 14, false, OpToken::binary, 1, 5, (OpToken*)0 };
        /// The \e in-place \e subtraction operator
        protected static readonly OpToken minusequal = new OpToken { "-=", "", 2, 14, false, OpToken::binary, 1, 5, (OpToken*)0 };
        /// The \e in-place \e left \e shift operator
        protected static readonly OpToken leftequal = new OpToken { "<<=", "", 2, 14, false, OpToken::binary, 1, 5, (OpToken*)0 };
        /// The \e in-place \e right \e shift operator
        protected static readonly OpToken rightequal = new OpToken { ">>=", "", 2, 14, false, OpToken::binary, 1, 5, (OpToken*)0 };
        /// The \e in-place \e logical \e and operator
        protected static readonly OpToken andequal = new OpToken { "&=", "", 2, 14, false, OpToken::binary, 1, 5, (OpToken*)0 };
        /// The \e in-place \e logical \e or operator
        protected static readonly OpToken orequal = new OpToken { "|=", "", 2, 14, false, OpToken::binary, 1, 5, (OpToken*)0 };
        /// The \e in-place \e logical \e xor operator
        protected static readonly OpToken xorequal = new OpToken { "^=", "", 2, 14, false, OpToken::binary, 1, 5, (OpToken*)0 };

        // Operator tokens for type expressions
        /// Type declaration involving a space (identifier or adornment)
        protected static readonly OpToken type_expr_space = new OpToken { "", "", 2, 10, false, OpToken::space, 1, 0, (OpToken*)0 };
        /// Type declaration with no space
        protected static readonly OpToken type_expr_nospace = new OpToken { "", "", 2, 10, false, OpToken::space, 0, 0, (OpToken*)0 };
        /// Pointer adornment for a type declaration
        protected static readonly OpToken ptr_expr = new OpToken { "*", "", 1, 62, false, OpToken::unary_prefix, 0, 0, (OpToken*)0 };
        /// Array adornment for a type declaration
        protected static readonly OpToken array_expr = new OpToken { "[", "]", 2, 66, false, OpToken::postsurround, 1, 0, (OpToken*)0 };
        /// The \e concatenation operator for enumerated values
        protected static readonly OpToken enum_cat = new OpToken { "|", "", 2, 26, true, OpToken::binary, 0, 0, (OpToken*)0 };
        ...
        protected void pushSymbolScope(Symbol symbol)
        {
            ...
            if (scopedepth != 0)
            {
                ...
                {
                    pushAtom(Atom(scopeList[i].getDisplayName(), syntax, EmitMarkup::global_color, (PcodeOp)null, (Varnode)null));
                }
            }
        }
        ...
        protected void emitEnumDefinition(TypeEnum ct)
        {
            ...
            while (iter != ct.endEnum())
            {
                ...
                emit.spaces(1);
                push_integer((*iter).first, ct.getSize(), sign, (Varnode)null,
                     (PcodeOp)null);
                recurse();
                emit.print(SEMICOLON);
                ++iter;
        ...
        protected virtual void pushSymbol(Symbol sym, Varnode vn, PcodeOp op)
        {
        ...
        protected virtual void pushUnnamedLocation(Address addr, Varnode vn, PcodeOp op)
        {
            ostringstream s;
        ...
        protected virtual void pushImpliedField(Varnode vn, PcodeOp op)
        {
            bool proceed = false;
        ...
        protected virtual void pushType(Datatype ct)
        {
        ...
        protected virtual void emitVarDeclStatement(Symbol sym)
        {
            emit.tagLine();
            emitVarDecl(sym);
            emit.print(SEMICOLON);
        ...
        protected virtual void emitFunctionDeclaration(Funcdata fd)
        {
            ...
            emit.tagFuncName(fd.getDisplayName(), EmitMarkup::funcname_color, fd, (PcodeOp)null);
        ...
        /// \param ct is the given data-type
        protected virtual void emitTypeDefinition(Datatype ct)
        {
#if CPUI_DEBUG
            if (!isStackEmpty())
            {
        ...
        protected virtual bool checkPrintNegation(Varnode vn)
        {
            if (!vn.isImplied()) return false;
            if (!vn.isWritten()) return false;
        ...
        public virtual void initializeFromArchitecture()
        {
        ...
        public virtual void adjustTypeOperators()
        {
            scope.print1 = "::";
            shift_right.print1 = ">>";
        ...
        public virtual void emitBlockBasic(BlockBasic bb)
        {
            PcodeOp* inst;
            bool separator;
        ...
        public virtual void emitBlockCopy(BlockCopy bl)
        {
            emitAnyLabelStatement(bl);
            bl.subBlock(0).emit(this);
        }

        public virtual void emitBlockGoto(BlockGoto bl)
        {
            pushMod();
            setMod(no_branch);
        ...
        public virtual void emitBlockCondition(BlockCondition bl)
        {
        ...
        public virtual void emitBlockSwitch(BlockSwitch bl)
        {
            FlowBlock* bl2;
            ...
            for (int i = 0; i < bl.getNumCaseBlocks(); ++i)
            {
                ...
                else
                {
                    ...
                    {   // Blocks that formally exit the switch
                        emit.tagLine();
                        emitGotoStatement(bl2, (FlowBlock*)0, FlowBlock::f_break_goto); // need an explicit break statement
                    }
                    emit.endBlock(id2);
                }
                emit.stopIndent(id);
        ...
        public virtual void opCopy(PcodeOp op)
        {
            pushVn(op.getIn(0), op, mods);
        }
        ...
        public virtual void opStore(PcodeOp op)
        {
            bool usearray;
        ...
        public virtual void opBranch(PcodeOp op)
        {
            if (isSet(flat))
            {
        ...
        public virtual void opCbranch(PcodeOp op)
        {
        ...
        public virtual void opBranchind(PcodeOp op)
        {
            // FIXME:  This routine shouldn't emit directly
        ...
        public virtual void opCall(PcodeOp op)
        {
            ...
            if (callpoint.getSpace().getType() == IPTR_FSPEC)
            {
                ...
                if (fc.getName().Length == 0)
                {
                    ...
                    pushAtom(Atom(nm, functoken, EmitMarkup::funcname_color, op, (Funcdata)null));
                }
                else
                {
                    ...
                    pushAtom(Atom(fc.getName(), functoken, EmitMarkup::funcname_color, op, (Funcdata)null));
                }
            }
            else
            {
        ...
        public virtual void opCallind(PcodeOp op)
        {
            pushOp(&function_call, op);
            pushOp(&dereference, op);
            Funcdata fd = op.getParent().getFuncdata();
        ...
        public virtual void opConstructor(PcodeOp op,bool withNew)
        {
            Datatype* dt;
            if (withNew)
            {
        ...
        public virtual void opReturn(PcodeOp op)
        {
            string nm;
        ...
        public virtual void opIntEqual(PcodeOp op)
        {
            opBinary(&equal, op);
        }

        public virtual void opIntNotEqual(PcodeOp op)
        {
            opBinary(&not_equal, op);
        }

        public virtual void opIntSless(PcodeOp op)
        {
            opBinary(&less_than, op);
        }

        public virtual void opIntSlessEqual(PcodeOp op)
        {
            opBinary(&less_equal, op);
        }

        public virtual void opIntLess(PcodeOp op)
        {
            opBinary(&less_than, op);
        }

        public virtual void opIntLessEqual(PcodeOp op)
        {
            opBinary(&less_equal, op);
        }

        public virtual void opIntZext(PcodeOp op, PcodeOp readOp)
        {
        ...
        public virtual void opIntSext(PcodeOp op, PcodeOp readOp)
        {
        ...
        public virtual void opIntAdd(PcodeOp op)
        {
            opBinary(&binary_plus, op);
        }

        public virtual void opIntSub(PcodeOp op)
        {
            opBinary(&binary_minus, op);
        }

        public virtual void opIntCarry(PcodeOp op)
        {
            opFunc(op);
        }

        public virtual void opIntScarry(PcodeOp op)
        {
            opFunc(op);
        }

        public virtual void opIntSborrow(PcodeOp op)
        {
            opFunc(op);
        }

        public virtual void opInt2Comp(PcodeOp op)
        {
            opUnary(&unary_minus, op);
        }

        public virtual void opIntNegate(PcodeOp op)
        {
            opUnary(&bitwise_not, op);
        }

        public virtual void opIntXor(PcodeOp op)
        {
            opBinary(&bitwise_xor, op);
        }

        public virtual void opIntAnd(PcodeOp op)
        {
            opBinary(&bitwise_and, op);
        }

        public virtual void opIntOr(PcodeOp op)
        {
            opBinary(&bitwise_or, op);
        }

        public virtual void opIntLeft(PcodeOp op)
        {
            opBinary(&shift_left, op);
        }

        public virtual void opIntRight(PcodeOp op)
        {
            opBinary(&shift_right, op);
        }

        public virtual void opIntSright(PcodeOp op)
        {
            opBinary(&shift_sright, op);
        }

        public virtual void opIntMult(PcodeOp op)
        {
            opBinary(&multiply, op);
        }

        public virtual void opIntDiv(PcodeOp op)
        {
            opBinary(&divide, op);
        }

        public virtual void opIntSdiv(PcodeOp op)
        {
            opBinary(&divide, op);
        }

        public virtual void opIntRem(PcodeOp op)
        {
            opBinary(&modulo, op);
        }

        public virtual void opIntSrem(PcodeOp op)
        {
            opBinary(&modulo, op);
        }
        ...
        public virtual void opBoolNegate(PcodeOp op)
        {
        ...
        public virtual void opBoolXor(PcodeOp op)
        {
            opBinary(&boolean_xor, op);
        }

        public virtual void opBoolAnd(PcodeOp op)
        {
            opBinary(&boolean_and, op);
        }

        public virtual void opBoolOr(PcodeOp op)
        {
            opBinary(&boolean_or, op);
        }

        public virtual void opFloatEqual(PcodeOp op)
        {
            opBinary(&equal, op);
        }

        public virtual void opFloatNotEqual(PcodeOp op)
        {
            opBinary(&not_equal, op);
        }

        public virtual void opFloatLess(PcodeOp op)
        {
            opBinary(&less_than, op);
        }

        public virtual void opFloatLessEqual(PcodeOp op)
        {
            opBinary(&less_equal, op);
        }

        public virtual void opFloatNan(PcodeOp op)
        {
            opFunc(op);
        }

        public virtual void opFloatAdd(PcodeOp op)
        {
            opBinary(&binary_plus, op);
        }

        public virtual void opFloatDiv(PcodeOp op)
        {
            opBinary(&divide, op);
        }

        public virtual void opFloatMult(PcodeOp op)
        {
            opBinary(&multiply, op);
        }

        public virtual void opFloatSub(PcodeOp op)
        {
            opBinary(&binary_minus, op);
        }

        public virtual void opFloatNeg(PcodeOp op)
        {
            opUnary(&unary_minus, op);
        }

        public virtual void opFloatAbs(PcodeOp op)
        {
            opFunc(op);
        }

        public virtual void opFloatSqrt(PcodeOp op)
        {
            opFunc(op);
        }

        public virtual void opFloatInt2Float(PcodeOp op)
        {
            opTypeCast(op);
        }

        public virtual void opFloatFloat2Float(PcodeOp op)
        {
            opTypeCast(op);
        }

        public virtual void opFloatTrunc(PcodeOp op)
        {
            opTypeCast(op);
        }

        public virtual void opFloatCeil(PcodeOp op)
        {
            opFunc(op);
        }

        public virtual void opFloatFloor(PcodeOp op)
        {
            opFunc(op);
        }

        public virtual void opFloatRound(PcodeOp op)
        {
            opFunc(op);
        }

        public virtual void opMultiequal(PcodeOp op)
        {
        }

        public virtual void opIndirect(PcodeOp op)
        {
        }

        public virtual void opPiece(PcodeOp op)
        {
            opFunc(op);
        }

        public virtual void opSubpiece(PcodeOp op)
        {
        ...
        public virtual void opCast(PcodeOp op)
        {
            opTypeCast(op);
        }
        ...
        public virtual void opPtrsub(PcodeOp op)
        {
            TypePointer* ptype;
        ...
        public virtual void opSegmentOp(PcodeOp op)
        {
            pushVn(op.getIn(2), op, mods);
        }
        ...
        public virtual void opInsertOp(PcodeOp op)
        {
            opFunc(op); // If no other way to print it, print as functional operator
        }

        public virtual void opExtractOp(PcodeOp op)
        {
            opFunc(op); // If no other way to print it, print as functional operator
        }

        public virtual void opPopcountOp(PcodeOp op)
        {
            opFunc(op);
        }

        public virtual void opLzcountOp(PcodeOp op)
        {
            opFunc(op);
        }
